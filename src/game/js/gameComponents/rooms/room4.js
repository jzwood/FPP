FPP.ROOM4 = (function(window, document, undefined) {
  ...
  var room4 = new function() {
    ...
    this.bLwall = { 'specs':{ 'translate': new THREE.Vector3(-3.5, -5.5, -20), 'rx':Math.PI/2,'ry':0,'rz':0,'width':3,'height': 9, 'image_path': '../assets/images/floor4.jpg' }, 'options' : { 'solid':true, 'stretch':true , 'side': 'd'} }
    ...
    this.bRwall = { 'specs':{ 'translate': new THREE.Vector3(3.5, -5.5, -20), 'rx':Math.PI/2,'ry':0,'rz':0,'width':3,'height': 9, 'image_path': '../assets/images/floor4.jpg' }, 'options' : { 'solid':true, 'stretch':true, 'side': 'd' } }
    ...
    this.b2 = { 'specs':{ 'translate': new THREE.Vector3(2.2, -5.5, 0), 'rx':0,'ry':0,'rz':Math.PI/2,'width':9,'height':40, 'image_path': '../assets/images/floor4.jpg' }, 'options' : { 'solid':true, 'stretch':false, 'wrap_w':2, 'wrap_h':10 } }
    this.walls.push(this.b2)

    this.c2 = { 'specs':{ 'translate': new THREE.Vector3(-2.2, -5.5, 0), 'rx':0,'ry':0,'rz':-Math.PI/2,'width':9,'height':40, 'image_path': '../assets/images/floor4.jpg' }, 'options' : { 'solid':true, 'stretch':false, 'wrap_w':2, 'wrap_h':10 } }
