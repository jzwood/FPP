FPP.ROOM4 = (function(window, document, undefined) {
  ...
  var room4 = new function() {
    ...
    this.door1 = { 'specs':{ 'id': 5, 'translate': new THREE.Vector3(0,-12,0), 'rx':Math.PI/2,'ry':0,'rz':0,'width':10,'height': 9, 'image_path': './assets/images/door.jpg' }, 'options' : { 'solid':true, 'stretch':true , 'side': 'd'} }
    this.walls.push(this.door1)

    this.btn1 = {'specs': { 'id': 5, 'translate' : new THREE.Vector3(0,-10+0.01,-4), 'path' : './assets/images/btn1.png' , 'isSbutton': false}}
    ...
    this.btn2b= {'specs': { 'id': 6, 'translate' : new THREE.Vector3(0,-10+0.01,-4), 'path' : './assets/images/btn2.png' , 'isSbutton': true, 'invisible': false}}
    this.btns.push(this.btn2b)

    this.door2 = { 'specs':{ 'id': 6, 'translate': new THREE.Vector3(0, -5.5, 20), 'rx':-Math.PI/2,'ry':0,'rz':0,'width':10,'height': 9, 'image_path': './assets/images/door.jpg' }, 'options' : { 'solid':true, 'stretch':true , 'side': 'd'} }
